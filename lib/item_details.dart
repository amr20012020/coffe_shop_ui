...
import 'package:coffe_shop_ui/models/Coffe-Item.dart';
...
class ItemDetails extends StatefulWidget {
  ...
  const ItemDetails({Key? key, required this.cItem}) : super(key: key);
    ...
    return Scaffold(
      body: Stack(
        ...
        [
          ...
          Hero(
              tag: widget.cItem.Image.toString(),
              child: Container(
                decoration: BoxDecoration(
                  image: DecorationImage(
                    image: AssetImage(widget.cItem.Image.toString(),),
                    fit: BoxFit.cover,
                  ),
                ),
              ),
    ...
    return AnimatedContainer(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(10.0),
          border: index == selectedIndex ? Border.all(
            color: ColorPalette().coffeeSelected,
        ...
        child: Center(
          child: Text(
            title,
            style: GoogleFonts.sourceSansPro(
              color: index == selectedIndex ? ColorPalette().coffeeSelected : Color(0xFFADADAD),
              fontSize: 15.0,
            ),
          ),
        ),
